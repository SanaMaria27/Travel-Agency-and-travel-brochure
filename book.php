...
<body>
    <div id="bookingDetails">
        ...
        <form action="process_booking.php" method="post">
            ...
            <p><strong>Package Name:</strong> <?php echo $_GET['package_name'] ?? ''; ?></p>
            <p><strong>Destination:</strong> <?php echo $_GET['destination'] ?? ''; ?></p>
            <p><strong>Duration:</strong> <?php echo $_GET['duration'] ?? ''; ?></p>
            <p><strong>Price:</strong> <?php echo $_GET['price'] ?? ''; ?></p>
            <!-- Add hidden input fields to store package information -->
            <input type="hidden" name="package_name" value="<?php echo $_GET['package_name'] ?? ''; ?>">
            <input type="hidden" name="destination" value="<?php echo $_GET['destination'] ?? ''; ?>">
            <input type="hidden" name="duration" value="<?php echo $_GET['duration'] ?? ''; ?>">
